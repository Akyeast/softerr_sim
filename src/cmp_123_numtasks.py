...
def exp(tasks, cfg, logger):
    for task_set in tasks:
        ...
        for s in range(cfg['num_states']):
            ...
            # print(state_ts)
            new_num_task_schedulable_only_lockstep, _, _ = get_num_task_schedulable_only_lockstep(state_ts, cfg['delta'], cfg['num_core'], cfg['max_num_task'], cfg['binding_constant'], cfg['transform_constant'])
            new_num_task_schedulable_dynamic_switching, _, _ = get_num_task_schedulable_dynamic_switching(state_ts, cfg['delta'], cfg['num_core'], cfg['max_num_task'], cfg['binding_constant'], cfg['transform_constant'])
            new_num_task_schedulable_ours, _, _ = get_num_task_schedulable_ours(state_ts, cfg['delta'], cfg['num_core'], cfg['max_num_task'], cfg['binding_constant'], cfg['transform_constant'])
