...
def check_schedulable_only_lockstep(tasks, delta=1.0, num_core=8):
    ...
    # c_tasks = [task for task in tasks if (task[2] == 0 or task[2] == 1)]
    # c_tasks = tasks
    # nc_tasks = []
    ...
    # print(f'DEBUG_only_lockstep___1: {mapped_c_tasks}')
    ...
    # print(f'DEBUG_only_lockstep___2: {mapped_tasks}')
...
def assign_onlyls_tda_reserve_rerun(core, tasks, delta):
    ...
    # print(f'DEBUG_only_lockstep:{assigned_utils}')
    ### check
